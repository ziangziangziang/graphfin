...
#
# The arm64 image pinned in ci/phase0/images.lock cannot be rebuilt from HEAD:
# its Dockerfile revision COPYs files (ci/images/vendor/...) that are absent from
# this tree (see ci/phase0/env/README.md "Provenance gap"). This script provides
# a reproducible-from-source alternative on the x86_64 path used by CI and the
# test host:
#
#   ci/phase0/build_image.sh
#
